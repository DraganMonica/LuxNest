...
using LuxNest.Infrastructure.Emails;
using LuxNest.Infrastructure.Repository;
using LuxNest.Web.Services;
...
builder.Services.AddHostedService<BookingAutoCompleteService>();
