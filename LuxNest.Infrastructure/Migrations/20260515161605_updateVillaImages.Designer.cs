...
namespace LuxNest.Infrastructure.Migrations
{
    ...
    [Migration("20260515161605_updateVillaImages")]
    partial class updateVillaImages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LuxNest.Domain.Entities.Amenity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LuxNest.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LuxNest.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LuxNest.Domain.Entities.Villa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ImageUrl = "/images/VillaImage/158817b0-0967-48a9-8809-07ef0ad1fe5a.jpg",
                            Name = "Royal Villa",
                            Occupancy = 4,
                            Price = 200.0,
                            Sqft = 550
                        ...
                        new
                        {
                            ...
                            ImageUrl = "/images/VillaImage/e801cc6a-c896-4357-aea8-9eb0a25cb596.jpg",
                        ...
                        new
                        {
                            ...
                            ImageUrl = "/images/VillaImage/48678a87-ce4d-4751-acab-b12ad9c06341.jpg",
            ...
            modelBuilder.Entity("LuxNest.Domain.Entities.VillaNumber", b =>
                {
            ...
            modelBuilder.Entity("LuxNest.Domain.Entities.Amenity", b =>
                {
                    b.HasOne("LuxNest.Domain.Entities.Villa", "Villa")
            ...
            modelBuilder.Entity("LuxNest.Domain.Entities.Booking", b =>
                {
                    b.HasOne("LuxNest.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LuxNest.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
